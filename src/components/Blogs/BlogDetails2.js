     ...
     <div className="col-lg-8 posts-list">
      <div className="single-post">
       <div className="feature-img">
        <img className="img-fluid" src="assets/img/blog/woman2.jpg" alt=""/>
      </div>
      <div className="blog_details">
        <h2 style={{color: "#2d2d2d"}}>When life is a drag, Yoga is there to lift you up
       </h2>
       <ul className="blog-info-link mt-3 mb-4">
         <li><a href="#"><i className="fa fa-user"></i> Yoga, Fitness</a></li>
